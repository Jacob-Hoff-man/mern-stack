...
export default function NewPost (props){
    ...
    /* invoked upon new post submission */
    /* upon successful post creation, the form view is emptied and addUpdate is exectued to refresh Newsfeed */
    const clickPost = () => {
