...
export default function Home(){
  ...
  /* retrieve list of enrolled courses from the BE */
  /* enrolled array is set to the current state */  
  useEffect(() => {
  ...
  /* retrieve list of published courses from the BE */
  /* courses array is set to the current state */
  useEffect(() => {
    const abortController = new AbortController()
    const signal = abortController.signal
