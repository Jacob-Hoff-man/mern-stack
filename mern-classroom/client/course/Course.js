...
export default function Course ({match}) {
    ...
    /* retrieve the course details with the fetch call to read API */
    ...
    /* retrieve the enrollment statistic details with the fetch call to enrollmentStats API */
    /* set the received values to state */
    useEffect(() => {
      const abortController = new AbortController()
      const signal = abortController.signal
    ...
    /* update function executed to render the latest lessons in the Course component */
    /* sent as a prop to the NewLesson component */
    const addLesson = (course) => {
      setCourse(course)
    }

    /* called when the publish button is clicked */
    /* opens the dialog box if the lenght of the lessons array is more than zero */
    const clickPublish = () => {
    ...
    /* called when an instructor confirms the publishing of a course */
    /* updates the published attribute with API call */
    const publish = () => {
