...
export default function NewLesson(props) {
    ...
    /* initializing the form values in the state */
    ...
    /* values that are entered into the DialogContent TextField inputs are captured and used to update current State */ 
    const handleChange = name => event => {
      setValues({ ...values, [name]: event.target.value })
    }
    
    /* upon clicking submit, current state values are sent as a new Lesson to db */
    /* courseId, addLesson received as prop from Course component */
    const clickSubmit = () => {
    ...
    /* Dialog component from MaterialUI (used in React component) stays open or closed */
    /* this is dependent on the open variable, below are handler functions */
    /* "Add Lesson" Button in React component toggles Dialog component */
...
/* required props received from Course component */
NewLesson.propTypes = {
